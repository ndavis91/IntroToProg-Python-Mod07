...
#   N.Davis,11/26/2023,Created Script
...
class Person:
    ...
    N.Davis, 11/26/2023,Created Class
...
# Create a getter and setter for the first_name property (Done)
# Create a getter and setter for the last_name property (Done)
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        N.Davis, 11/26/2023,Created Function
